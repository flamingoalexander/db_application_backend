...
const disciplines_and_specialtiesApi = require('@/app/routes/tables/phone_numbers')
const employees_and_departmentsApi = require('@/app/routes/tables/phone_numbers')
